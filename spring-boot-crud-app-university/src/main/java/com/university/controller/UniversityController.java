...
public class UniversityController {
    ...
    public ResponseEntity<UniversitySearchResponseDTO> searchUniversityWithPagination(@RequestBody SearchDTO searchDTO) {
        return new ResponseEntity<>(universityService.searchUniversity(searchDTO),HttpStatus.OK);
    }
}
