...
<h1  style="color:blue;text-align:center"> Pagination Report Page</h1>

<c:choose>
   <c:when  test="${!empty  pageDetails}">
      <table border="1" align="center" bgcolor="yellow">
         <tr>
           <th>EMPNO</th><th>EMPNAME</th><th>JOB</th><th>SAL</th><th>DEPTNO</th>
           <th> Operations </th>
         </tr>
        <c:forEach  items="${pageDetails}"  var="emp" >
            <tr>
              <td>${emp.empno} </td>
             <td>${emp.empname} </td>
             <td>${emp.job} </td>
